   ...
   text-align: center;
    ...
    <main>
        <div class="container title ">
            ...
            <div class="row justify-content-center align-items-center h-100">
                <form method="POST">
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control" id="formTitle" name="title" placeholder="Title post">
            ...
            <div class="row justify-content-center align-items-center h-100">
                <div class="create  "><input class="btn btn-primary"  type="submit" value="Create" onclick="post.add()" ></div>
            </div>
